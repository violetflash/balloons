    ...
    other: [
        {
            ...
            size: '48см',
            country: 'Россия',
            additional: ['Фиолетовый', 'Белый', 'Синий', 'Красный'],
        },
        {
            ...
            size: '150см/48см',
            country: 'Россия',
            additional: ['20 отверстий', '30 отверстий', '40 отверстий', '50 отверстий'],
        },
        {
            ...
            size: '200см * 100см',
            country: 'Испания',
            additional: ['100 шаров', '200 шаров', '300 шаров', '500 шаров'],
        },
        {
            ...
            size: 'квадраты 2см',
            country: 'Испания',
            additional: ['Золото', 'Серебро', 'Ассортимент цветов'],
        },
        {
            name: 'Воздух',
            ...
            size: 'без размера',
            country: 'Россия',
            description: 'Чистейший воздух с высокогорных долин России. Можно добавить ароматов на Ваш вкус!',
            additional: ['Простой', 'Апельсиновый', 'Клубничный', 'Лесные ароматы'],
        },
    ]
};
